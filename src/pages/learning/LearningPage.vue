...
<template>
  <div class="page-view">
    ...
    <div class="view-nav">
      ...
      <button @click="$router.push('/lessons-learned')" class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-amber-600 hover:bg-amber-50 rounded-lg transition-colors">
