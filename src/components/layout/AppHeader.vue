  ...
  <header class="header-enhanced fixed top-0 left-0 right-0 z-50 h-16">
    <div class="h-full px-4 flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        <button @click="uiStore.toggleSidebar" class="header-btn group" title="Toggle Sidebar">
          ...
          <div class="search-inner">
            <div class="flex items-center gap-3 px-4">
              ...
              <input
                ...
                placeholder="Search anything... articles, documents, people, events"
              ...
              <div class="flex items-center gap-2">
                ...
                <button @click="openAIAssistant" class="ai-search-btn group/ai" title="AI-Powered Search">
      ...
      <div class="flex items-center gap-1">
        ...
        <div class="relative header-dropdown-trigger">
          <button @click.stop="toggleCreate" class="header-btn group" title="Create New">
          ...
          <Transition name="dropdown">
            <div v-if="showCreateMenu" class="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 z-50">
              <div class="px-3 py-2 border-b border-gray-100">
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Create New</p>
              </div>
              <div class="py-1">
                <button @click="navigateTo('ArticleCreate')" class="flex items-center gap-3 w-full px-3 py-2 hover:bg-gray-50">
                  ...
                  <div class="text-left">
                    <p class="text-sm font-medium text-gray-700">Article</p>
                    <p class="text-xs text-gray-400">Write a new article</p>
                  </div>
                </button>
                <button @click="navigateTo('PollCreate')" class="flex items-center gap-3 w-full px-3 py-2 hover:bg-gray-50">
                  ...
                  <div class="text-left">
                    <p class="text-sm font-medium text-gray-700">Poll</p>
                    <p class="text-xs text-gray-400">Create a survey</p>
                  </div>
                </button>
                <button @click="navigateTo('Events')" class="flex items-center gap-3 w-full px-3 py-2 hover:bg-gray-50">
                  ...
                  <div class="text-left">
                    <p class="text-sm font-medium text-gray-700">Event</p>
                    <p class="text-xs text-gray-400">Schedule an event</p>
                  </div>
                </button>
                <button @click="navigateTo('Documents')" class="flex items-center gap-3 w-full px-3 py-2 hover:bg-gray-50">
                  ...
                  <div class="text-left">
                    ...
                    <p class="text-xs text-gray-400">Upload a file</p>
                  </div>
                </button>
              </div>
            </div>
        ...
        <!-- Notifications -->
        <div class="relative header-dropdown-trigger">
          <button @click.stop="toggleNotifications" class="header-btn group" title="Notifications">
          ...
          <Transition name="dropdown">
            <div v-if="showNotifications" class="absolute right-0 top-full mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-100 z-50">
              <div class="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
                ...
                <button @click="markAllRead" class="text-xs text-teal-600 hover:text-teal-700 font-medium">Mark all read</button>
              </div>
