export default {
  ...
  polls: {
    ...
    description: 'Gather feedback and insights from your team. Create polls, collect responses, and analyze results.',
    allPolls: 'All Polls',
    myPolls: 'My Polls',
    activePolls: 'Active Polls',
    ...
    discoverVotingPatterns: 'Discover voting behavior patterns',
    identifiedPatterns: 'Identified {count} significant voting patterns',
  ...
  services: {
    ...
    serviceItems: {
      ...
      passwordResetDesc: 'Reset your account password',
      softwareRequest: 'Software Request',
      softwareRequestDesc: 'Request new software installation',
      hardwareRequest: 'Hardware Request',
      hardwareRequestDesc: 'Request new equipment or peripherals',
      vpnAccess: 'VPN Access',
      vpnAccessDesc: 'Request VPN access for remote work',
      leaveRequest: 'Leave Request',
      leaveRequestDesc: 'Submit vacation or sick leave',
      benefitsInquiry: 'Benefits Inquiry',
      benefitsInquiryDesc: 'Questions about benefits and insurance',
      trainingRequest: 'Training Request',
      trainingRequestDesc: 'Request professional development training',
      roomBooking: 'Room Booking',
      roomBookingDesc: 'Reserve meeting rooms and spaces',
      maintenanceRequest: 'Maintenance Request',
      maintenanceRequestDesc: 'Report facility issues',
      expenseReport: 'Expense Report',
      expenseReportDesc: 'Submit expense reimbursement',
      travelRequest: 'Travel Request',
      travelRequestDesc: 'Request travel approval',
    },
    // Priority levels
    priorities: {
      quick: 'Quick',
    ...
    aiRecommendedServices: 'AI-recommended services for you',
    recommendedServices: 'Recommended Services',
    match: 'Match',
    refresh: 'Refresh',
    close: 'Close',
    // AI Auto-fill Modal
    suggestedRequestDetails: 'Suggested request details',
    generatingFormSuggestions: 'Generating form suggestions...',
  ...
  settings: {
    ...
    notificationItems: {
      comments: 'Comments on my content',
      commentsDesc: 'When someone comments on your articles or posts',
      mentions: 'Mentions',
      mentionsDesc: 'When someone mentions you',
      reactions: 'Reactions',
      reactionsDesc: 'When someone reacts to your content',
      news: 'Company News',
      newsDesc: 'Important announcements and updates',
      events: 'Events',
      eventsDesc: 'Upcoming events and reminders',
      courses: 'Learning Updates',
      coursesDesc: 'New courses and learning opportunities',
    },
    // Privacy Settings
    ...
    privacyOptions: {
      ...
      showActivityDesc: "Display when you're online",
      showContributions: 'Show Contributions',
      showContributionsDesc: 'Display your articles and comments publicly',
      appearInSearch: 'Appear in Search',
      appearInSearchDesc: 'Allow your profile to appear in search results',
      usageAnalytics: 'Usage Analytics',
      usageAnalyticsDesc: 'Help improve the platform with anonymous usage data',
    },
    ...
    compactModeDesc: 'Reduce spacing and padding',
    animations: 'Animations',
    animationsDesc: 'Enable interface animations',
    // Language Settings
    languageRegion: 'Language & Region',
    languagePreferences: 'Set your language and regional preferences',
    ...
    revoke: 'Revoke',
    current: 'Current',
    signOutAllSessions: 'Sign out all other sessions',
    // Connected Apps
    connectedAppsTitle: 'Connected Apps',
    manageIntegrations: 'Manage third-party app integrations',
    connected: 'Connected',
    disconnect: 'Disconnect',
    connectNewApp: 'Connect New App',
    // Keyboard Shortcuts
    keyboardShortcuts: 'Keyboard Shortcuts',
    speedUpWorkflow: 'Speed up your workflow with keyboard shortcuts',
    ...
    shortcuts: {
      ...
      submitForm: 'Submit/Save form',
      openAIAssistant: 'Open AI Assistant',
      aiSummarize: 'AI Summarize selection',
      aiTranslate: 'AI Translate selection',
    },
    proTips: 'Pro Tips',
    proTipsList: {
      tip1: 'Press ? anywhere to see available shortcuts',
      tip2: 'Two-key shortcuts (like G + H) should be pressed in sequence, not together',
      tip3: 'Shortcuts are disabled when typing in text fields',
    },
    printShortcuts: 'Print Shortcut Reference',
    // AI Settings
    aiSettings: 'AI Settings',
    manageAIFeatures: 'Manage your AI features and preferences',
    ...
    aiFeatures: 'AI Features',
    enableDisableAI: 'Enable or disable specific AI capabilities',
    aiFeatureToggles: {
      smartSuggestions: 'Smart Suggestions',
      smartSuggestionsDesc: 'Get AI-powered suggestions while creating content',
      autoSummarization: 'Auto Summarization',
      autoSummarizationDesc: 'Automatically generate summaries for long content',
      aiTranslation: 'AI Translation',
      aiTranslationDesc: 'Translate content to different languages using AI',
      aiAssistantChat: 'AI Assistant Chat',
      aiAssistantChatDesc: 'Enable the AI chatbot for questions and assistance',
      autoClassification: 'Auto Classification',
      autoClassificationDesc: 'Automatically categorize and tag uploaded content',
      documentOCR: 'Document OCR',
      documentOCRDesc: 'Extract text from images and scanned documents',
      sentimentAnalysis: 'Sentiment Analysis',
      sentimentAnalysisDesc: 'Analyze emotional tone in feedback and comments',
      personalizedRecommendations: 'Personalized Recommendations',
      personalizedRecommendationsDesc: 'Get AI-powered content recommendations based on your activity',
    },
    translationPreferences: 'Translation Preferences',
    configureLanguages: 'Configure your preferred languages for AI translation',
    defaultTranslationLanguage: 'Default Translation Language',
    translationLanguageHint: 'Content will be translated to this language by default',
    preferredSummaryLength: 'Preferred Summary Length',
    summaryLengthOptions: {
      brief: 'Brief',
      briefDesc: '2-3 sentences',
      medium: 'Medium',
      mediumDesc: '1-2 paragraphs',
      detailed: 'Detailed',
      detailedDesc: 'Comprehensive summary',
    },
    aiBehavior: 'AI Behavior',
    customizeAIBehavior: 'Customize how AI features work for you',
    confidenceThreshold: 'Confidence Threshold',
    confidenceThresholdHint: 'Only show AI suggestions with confidence above this threshold',
    showConfidenceScores: 'Show Confidence Scores',
    showConfidenceScoresDesc: 'Display AI confidence levels on suggestions',
    autoApplySuggestions: 'Auto-Apply Suggestions',
    autoApplySuggestionsDesc: 'Automatically apply high-confidence suggestions',
    aiDataUsageConsent: 'AI Data Usage Consent',
    aiDataUsageConsentDesc: 'Allow your interactions to improve AI models',
    aiDataPrivacy: 'AI Data & Privacy',
    manageAIData: 'Manage your AI interaction data',
    aiInteractionHistory: 'AI Interaction History',
    aiInteractionHistoryDesc: 'Your AI chat history, summaries, and translations are stored locally for personalization.',
    exportData: 'Export Data',
    clearHistory: 'Clear History',
    aboutAIData: 'About Your AI Data',
    aboutAIDataDesc: 'Your AI interactions are processed securely by the Intalio AI Engine. Personal data is never shared with third parties without your explicit consent.',
    resetToDefaults: 'Reset to Defaults',
    saveAISettings: 'Save AI Settings',
    // AI Connection Test Modal
    aiConnectionTest: 'AI Connection Test',
    testingConnection: 'Testing Intalio AI Engine connection',
    testingAIServices: 'Testing connection to AI services...',
    ...
    aiSettingsReset: 'AI settings reset to defaults!',
    clearAIHistoryConfirm: 'Are you sure you want to clear your AI interaction history? This action cannot be undone.',
    aiHistoryCleared: 'AI history cleared successfully!',
  },
